...
CREATE TABLE "DealershipInfo" (
    ...
    "address" TEXT NOT NULL DEFAULT '2799/13 Churiya Mohalla Village TKD',
    "phone" TEXT NOT NULL DEFAULT '+91 8287698319',
    "email" TEXT NOT NULL DEFAULT 'thecoder780@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
